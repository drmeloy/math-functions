...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    const mulOne = (multiply(a, b))[0];
    const mulTwo = (multiply(mulOne, c))[0];
    return [sumTwo, mulTwo, `${a} and ${b} and ${c} sum to ${sumTwo}.`, `The product of ${a} and ${b} and ${c} is ${mulTwo}.`];
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    return [sumTwo, `The numbers ${sumArr[0]},${sumArr[1]},${sumArr[2]} have a sum of ${sumTwo}.`];
}
...
export function multiplyArrayWithThreeNumbers(multArr) {
    ...
    return [mulTwo, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${mulTwo}.`];   
}
...
export function multiplyAnyArray(dynamicArray) {
    ...
    for(let i = 0; i < dynamicArray.length; i++){
        multTotal = multiply(multTotal, dynamicArray[i])[0];
    }
